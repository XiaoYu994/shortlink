...
package com.xhy.shortlink.framework.starter.idempotent.toolkit;
...
public class SpELUtil {
    ...
    private static final List<String> SPEL_FLAGS = List.of("#", "T(");
    ...
    public static Object parseKey(String spEl, Method method, Object[] contextObj) {
        boolean isSpEL = SPEL_FLAGS.stream().anyMatch(spEl::contains);
        if (isSpEL) {
