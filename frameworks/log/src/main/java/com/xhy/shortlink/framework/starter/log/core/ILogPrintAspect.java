...
package com.xhy.shortlink.framework.starter.log.core;
...
import com.xhy.shortlink.framework.starter.log.annotation.ILog;
...
public class ILogPrintAspect {
     ...
     * 打印类或方法上的 {@link ILog}
     */
    @Around("@within(com.xhy.shortlink.framework.starter.log.annotation.ILog)"
            + " || @annotation(com.xhy.shortlink.framework.starter.log.annotation.ILog)")
    public Object printMLog(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            if (logAnnotation != null) {
                ...
                if (sra != null) {
                    methodType = sra.getRequest().getMethod();
                    requestURI = sra.getRequest().getRequestURI();
                }
                log.info("[{}] {}, executeTime: {}ms, info: {}",
                        methodType, requestURI,
