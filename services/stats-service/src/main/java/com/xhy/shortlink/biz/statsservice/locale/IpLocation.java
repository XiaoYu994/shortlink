...
public record IpLocation(String province, String city, String adcode) {

    public static IpLocation unknown() {
        return new IpLocation(LOCALE_UNKNOWN, LOCALE_UNKNOWN, LOCALE_UNKNOWN);
    }

    public boolean isUnknown() {
        return LOCALE_UNKNOWN.equals(province);
    }

    public String display() {
        return StrUtil.join("-", LOCALE_COUNTRY_CN, province, city);
    }
}
