...
import com.xhy.shortlink.biz.userservice.dto.resp.UserActualRespDTO;
...
public class UserController {
    ...
    public Result<Void> register(@Validated @RequestBody UserRegisterReqDTO requestParam) {
    ...
    public Result<Void> update(@Validated @RequestBody UserUpdateReqDTO requestParam) {
    ...
    public Result<UserLoginRespDTO> login(@Validated @RequestBody UserLoginReqDTO requestParam) {
