 ...
 */
@Configuration
@EnableConfigurationProperties(ShortLinkBloomFilterProperties.class)
public class RBloomFilterConfiguration {
     ...
     */
    @Bean
    public RBloomFilter<String> shortlinkUriCreateCachePenetrationBloomFilter(
            RedissonClient redissonClient, ShortLinkBloomFilterProperties properties) {
