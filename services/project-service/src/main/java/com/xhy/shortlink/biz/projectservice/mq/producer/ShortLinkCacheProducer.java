...
import static com.xhy.shortlink.biz.projectservice.common.constant.RocketMQConstant.CACHE_INVALIDATE_TAG;
import static com.xhy.shortlink.biz.projectservice.common.constant.RocketMQConstant.CACHE_INVALIDATE_TOPIC;
 ...
 */
@Component
public class ShortLinkCacheProducer extends AbstractCommonSendProduceTemplate<String> {

    public ShortLinkCacheProducer(@Autowired RocketMQTemplate rocketMQTemplate) {
