package com.xhy.shortlink.project.initialize;
...
import static com.xhy.shortlink.project.common.constant.RedisKeyConstant.SHORT_LINK_STATS_STREAM_GROUP_KEY;
...
public class ShortLinkStatsStreamInitializeTask implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        final Boolean hasKey = stringRedisTemplate.hasKey(SHORT_LINK_STATS_STREAM_TOPIC_KEY);
